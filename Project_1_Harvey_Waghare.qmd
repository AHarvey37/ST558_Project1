...
# Plot state data
plot.state(combined_data$non_county, var_name = "value")

# Plot county data with different parameters
plot.county(combined_data$county, state = "NC", group = "top", number = 20, var_name = "value")
plot.county(combined_data$county, state = "SC", group = "bottom", number = 7, var_name = "value")
plot.county(combined_data$county, var_name = "value")  # Default parameters
plot.county(combined_data$county, state = "PA", group = "top", number = 8, var_name = "value")
...
plot.state(combined_additional_data$non_county, var_name = "value")

# Plot additional county data with different parameters
plot.county(combined_additional_data$county, state = "CA", group = "top", number = 15, var_name = "value")
plot.county(combined_additional_data$county, state = "TX", group = "top", number = 4, var_name = "value")
plot.county(combined_additional_data$county, var_name = "value")  # Default parameters
plot.county(combined_additional_data$county, state = "NY", group = "top", number = 10, var_name = "value")
